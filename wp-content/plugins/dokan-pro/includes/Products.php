...
class Products {
    ...
    public function duplicate_product( $product_id ) {
        ...
        // If vendor is disabled, make product status from publish to pending
        if ( 'publish' === $product_status && ! dokan_is_seller_enabled( $user_id ) ) {
            $product_status = 'pending';
        }

        $clone_product->set_status( $product_status );
        $clone_product->save();
